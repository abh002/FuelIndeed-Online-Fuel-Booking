...
/**
 * Servlet implementation class DpChangePassword
 */
public class DpChangePassword extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DpChangePassword() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String password = DeliveryPersonFridge.getPassword();
        ...
        if(password.equals(currentPassword)){
            ...
            try  {
                ...
                String query = "UPDATE deliveryperson SET password=? WHERE id=? AND password=?";
