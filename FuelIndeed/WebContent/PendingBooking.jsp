...
<body>
    ...
    <div class="main-content">
        <nav class="navbar navbar-expand-lg navbar-dark">
            ...
            <button class="logout-btn ml-auto" onclick="location.href='fuelstationlogin.html'" formtarget="_self">
        ...
        <div class="container mt-4">
            ...
            <table>
                ...
                <tr>
                    ...
                    <td>
                        <a href="UpdateStatusOfBooking.jsp?status=<%= "Assign" %>&id=<%= rs.getInt(1) %>">Assign</a> /
                        <a href="UpdateStatusOfBooking.jsp?status=<%= "Reject" %>&id=<%= rs.getInt(1) %>">Reject</a>
                    </td>
                </tr>
                <%
                    }
