...
<body>
    ...
    <div class="main-content">
        ...
        <div class="container mt-4">
            ...
            <form class="search-bar" method="post" action="ViewFuelStation.jsp">
                <div class="form-row">
                    <div class="col-md-4 mb-3">
                        <input type="text" class="form-control" name="searchQuery" placeholder="Search by area, city, or pincode">
                    </div>
            ...
            <div class="table-container">
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        String sql = "select * from fuelstation where status=?";
                        if (searchQuery != null && !searchQuery.trim().isEmpty()) {
                            sql += " and (area like ? or city like ? or pincode like ?)";
                        }
                        try {
                        ...
                        <tr>
                            ...
                            <td><a href="BookFuel.jsp?id=<%= rs.getInt(1) %>">Book Fuel</a></td>
                        </tr>
                        <%
                            }
