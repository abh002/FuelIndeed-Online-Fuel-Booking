...
<body>
    ...
    <div class="main-content">
        ...
        <div class="container mt-4">
            <h2 class="text-center mb-4">Rejected Bookings</h2>
            <table>
                <tr>
		<th>Id</th>
		<th>UserId</th>
		...
		try{
			...
			PreparedStatement ps = con.prepareStatement("select * from Bookings where (status=? and stationId=?) and deliveryPersonId=0");
