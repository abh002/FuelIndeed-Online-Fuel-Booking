...
<body>
    ...
    <div class="main-content">
        ...
        <div class="container mt-4">
            <form action="BookFuel" method="post">
	<div class="form-row">
                <div class="form-group col-md-3">
                    <label for="fuelType">Fuel Type</label>
                    <input type="text" class="form-control" id="fuelType" name="fuelType" placeholder="Enter fuel type">
                </div>
                <div class="form-group col-md-3">
                    <label for="fuelQty">Fuel Quantity (in liters)</label>
                    <input type="number" class="form-control" id="fuelQty" name="fuelQty" placeholder="Enter fuel quantity">
                </div>
            </div>
            	<%
            	int s = Integer.parseInt(request.getParameter("id"));
            	BufferFridge.setStationId(s);
            	%>
